...
Bespoke solutions with .NET, C#, TypeScript, ADO .NET / EF, jQuery, LESS, WebAPI 2, TPL, Agile Development, Code Generation (M#), AWS, Azure

### Junior Analyst Programmer, [Travel Network Group](http://www.thetravelnetworkgroup.co.uk/) (2011 – 2012)

.NET MVC 4, NHibernate and Entity Framework, Dependency Injection with Spring .NET & Ninject, SOAP/XML Web Services, Threaded applications using .NET TPL, used SOA design (micro-services) and Agile Development. jQuery, CSS, XHTML and Selenium Web Driver Testing with .NET using Chrome, Firefox and IE.

### Workshop Assistant, [Kingston University](http://www.kingston.ac.uk/) (2010 – 2011)

I was employed as an assistant and exam invigilator for first year students for Ruby on Rails workshops.
...
**Overton Grange, London (2001 – 2006)** - GCSE’s including English, Maths & Science

## More Information

I've been driving for 10 years and hold a clean UK driver's license.  
I can casually play the guitar.  
I'm left handed :)
